...
VALUES ('Bills', 'São Roque', '1995-01-01')
...
--TRUNCATE TABLE tabela(DROP TABLE + CREATE TABLE)
TRUNCATE TABLE times 

--Restaura o passo do auto incremento 
--DBCC Checkident(tabela, reseed, valor de reinicio)
DBCC Checkident(times, reseed, 4005)
...
VALUES ('Michael Jordan', 2.01, '1985-10-12', 0, 4001)
