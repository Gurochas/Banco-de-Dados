...
public class DAO_mostraNota {
	
	private Connection c;
	
	public DAO_mostraNota() throws ClassNotFoundException, SQLException {
	...
	public void insereNotas (AlunoNota aluno) throws ClassNotFoundException, SQLException {
        GenericDao gDao = new GenericDao();
        c = gDao.getConnection();
