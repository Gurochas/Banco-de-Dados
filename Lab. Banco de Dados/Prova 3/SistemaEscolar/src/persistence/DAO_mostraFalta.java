...
public class DAO_mostraFalta {
	
	private Connection c;
	
	public DAO_mostraFalta() throws ClassNotFoundException, SQLException {
	...
	public void insereFalta (AlunoFalta aluno) throws ClassNotFoundException, SQLException {
        GenericDao gDao = new GenericDao();
        c = gDao.getConnection();
