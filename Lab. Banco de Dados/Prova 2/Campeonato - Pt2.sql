...
/*
Fazer uma aplicação em Java (Web (Servlets) ou Desktop (Swing ou JavaFX)) com SQL Server
...
INSERT INTO Times VALUES('Bragantino','Bragança Paulista','Nabi Abi Chedid')
...
INSERT INTO Times VALUES('Oeste','Barueri','Arena Barueri')
...
INSERT INTO Times VALUES('Red Bull Brasil','Campinas','Moisés Lucarelli')
...
/*
- Grupos (Coritnthians, Palmeiras, Santos e São Paulo NÃO PODEM estar no mesmo
 grupo) (A coluna Grupo não pode aceitar nenhum valor diferente de A, B, C, D)
 Grupos 
	(Grupo | CodigoTime)
*/
CREATE TABLE Grupos(
...
/*
- Jogos (A primeira fase ocorrerá em 12 datas seguidas, sempre rodada cheia (os 8
...
/*
  ...
  aleatoriamente (com exceção da regra já exposta em Grupos).
*/
...
BEGIN 
	INSERT INTO @table 
		SELECT ta.CodigoTime, ta.nomeTime, j.GolsTimeA, tb.CodigoTime, tb.NomeTime, j.GolsTimeB
