...
--AVG()   Média dos valores das linhas de uma coluna
--COUNT() Quantidade de linhas de uma coluna
--MAX()   Valor máximo encontrado na coluna  // Se for char, ordena a coluna ASC e retorna ultimo resultado 
--MIN()   Valor minimo encontrado na coluna  // Se for char, ordena a coluna ASC e retorna primeiro resultado 


--GROUP BY  - Agrupar linhasd de um select por uma dada cláusula 
--A funcão de agregação será aplicada nos grupos definidos pela cláusula 

--HAVING - Tem a mesma funcção do WHERE para aplicação de funções de agregação
